  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="../Golf/GolfCreate">Create</a>
          <a class="dropdown-item" href="../Golf/GolfRead">Read</a>
          <a class="dropdown-item" href="../Golf/GolfUpdate">Update</a>
          <a class="dropdown-item" href="../Golf/GolfDelete">Delete</a>
        </div>
        </li>
