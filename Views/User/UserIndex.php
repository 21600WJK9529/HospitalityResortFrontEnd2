  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="../Maintenance/UserCreate.php">Create</a>
          <a class="dropdown-item" href="../Maintenance/UserRead.php">Read</a>
          <a class="dropdown-item" href="../Maintenance/UserUpdate.php">Update</a>
          <a class="dropdown-item" href="../Maintenance/UserDelete.php">Delete</a>
        </div>
        </li>
